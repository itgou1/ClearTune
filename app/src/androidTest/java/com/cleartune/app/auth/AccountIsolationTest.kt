...
class AccountIsolationTest {
    @Test fun searchHistoryAndSyncTimeBelongToTheirAccount() = runBlocking {
        ...
        preferences.markSongMetadataVerified(alice, "same-song", 456L)
        ...
        assertEquals(456L, preferences.songMetadataVerificationEpochMs(alice, "same-song"))
        assertEquals(0L, preferences.songMetadataVerificationEpochMs(bob, "same-song"))
        assertEquals(0L, preferences.songMetadataVerificationEpochMs(alice, "other-song"))
